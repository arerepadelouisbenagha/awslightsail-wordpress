...
Lightsail domain entry that maps the `example.com` domain to the load balancer and SSL certificate.
...
Once the apply has completed, you can check the AWS Lightsail console to confirm that your instance, load balancer, SSL certificate, static IP, and DNS have been created.
